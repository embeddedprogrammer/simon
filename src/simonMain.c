...
#define TIMER_PERIOD GLOBALS_TIMER_PERIOD
...
int main()
{
	...
	display_init();
	display_fillScreen(DISPLAY_BLACK); // This takes 165 ms, so we shouldn't do it inside the loop.
	...
	intervalTimer_init(1); // To test tick duration
	double seconds;
